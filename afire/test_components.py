...
if six.PY3:
    from afire import test_components_py3 as py3  # pylint: disable=unused-import,no-name-in-module,g-import-not-at-top
...
class CallableWithTypedKeywordArgument(object):
    ...
    def TupleType(self, foo: Tuple[int, str]):
        self.print_with_type(foo, "foo")

    def TupleOptionalType(self, foo: Tuple[int, Optional[str]]):
        self.print_with_type(foo, "foo")
    ...
    def PartialSetType(self, foo: Set):
        self.print_with_type(foo, "foo")
