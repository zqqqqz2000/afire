...
class FireTest(testutils.BaseTestCase):
    ...
    def testFireKeywordArgs(self):
        self.assertEqual(
            fire.Fire(tc.Kwargs, command=["props", "--name", "David", "--age", "24"]), {"name": "David", "age": 24}
        )
        ...
        self.assertEqual(
            fire.Fire(tc.Kwargs, command=["upper", "--alpha", "A", "--beta", "B", "-", "lower"]), "alpha beta"
        )

    def testFireKeywordArgsWithMissingPositionalArgs(self):
        self.assertEqual(
            fire.Fire(tc.Kwargs, command=["run", "Hello", "World", "--cell", "is"]), ("Hello", "World", {"cell": "is"})
        )
        self.assertEqual(
            fire.Fire(tc.Kwargs, command=["run", "Hello", "--cell", "ok"]), ("Hello", None, {"cell": "ok"})
        )
    ...
    def testBoolParsingLessExpectedCases(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "True", '"--test"']), (True, "--test")
        )
        # To get ('--test', '0'), use one of the following:
        self.assertEqual(fire.Fire(tc.MixedDefaults, command=["identity", "--alpha=--test"]), ("--test", "0"))
        self.assertEqual(fire.Fire(tc.MixedDefaults, command=r"identity --alpha \"--test\""), ("--test", "0"))
    ...
    def testBasicSeparator(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-", "_", "--", "--separator", "&"]), ("-", "_")
        )
    ...
    def testExtraSeparators(self):
        self.assertEqual(
            fire.Fire(tc.ReturnsObj, command=["get-obj", "arg1", "arg2", "-", "-", "as-bool", "True"]), True
        )
        self.assertEqual(
            fire.Fire(tc.ReturnsObj, command=["get-obj", "arg1", "arg2", "-", "-", "-", "as-bool", "True"]), True
        )
    ...
    def testSeparatorForChaining(self):
        ...
        self.assertIsInstance(
            fire.Fire(tc.ReturnsObj, command=["get-obj", "arg1", "arg2", "as-bool", "True"]), tc.BoolConverter
        )
        ...
        self.assertEqual(
            fire.Fire(tc.ReturnsObj, command=["get-obj", "arg1", "$$", "as-bool", "True", "--", "--separator", "$$"]),
            True,
        )
